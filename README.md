...
[Java语法格式，常量和变量](https://www.runoob.com/java/java-basic-syntax.html)，变量的作用域，方法和方法的重载，运算符，程序流程控制，[各种基本数据类型及包装类](https://www.cnblogs.com/HuiH/p/11665880.html)
...
2-5 JVM内存模型、[垃圾回收](/Java/GC学习.md) 、[G1 Gc](/Java/G1GC.md)、[Z Gc](/Java/ZGC.md)
...
[Git上传华为云(基于SSH公钥免密)](https://blog.csdn.net/qq_40542534/article/details/108657556/)
...
产品管理、[项目管理](/article/Administration.md)、团队建设、团队提升

[项目生命周期](/article/项目生命周期.md)

[产品设计的关键点](article/产品设计的关键点.md)
